...
public class WheelView extends View {
	...
	private int wheel_bg = R.drawable.wheel_bg;
	private int wheel_val = R.drawable.wheel_val;
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(wheel_val);
		}
	...
	public void setWheelBackground(int backgroundresourceid) {
		wheel_bg = backgroundresourceid;
		setBackgroundResource(backgroundresourceid);
	}

	public void setWheelForeground(int foregroundresourceid) {
		wheel_val = foregroundresourceid;
		centerDrawable = getContext().getResources().getDrawable(wheel_val);
	}
}
