...
//		((ImageView) findViewById(R.id.img_bg)).setImageBitmap(w.a().d());
		...
		package_company_select.setLisntener(new PackageSelectView.OnSelectListener() {
				...
				JuheData.executeWithAPI(43,
						...
						JuheData.GET, params, new DataCallBack() {
							...
							public void resultLoaded(int err, String reason,
								...
								if (err == 0) {
									PackageEntity entity = new Gson().fromJson(result, PackageEntity.class);
